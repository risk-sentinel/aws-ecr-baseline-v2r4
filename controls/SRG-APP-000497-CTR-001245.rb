control 'SRG-APP-000497-CTR-001245' do
  ...
  desc 'Unauthorized users could modify the security levels
                ...
                unauthorized users can modify security levels unknowingly for malicious intent
  ...
  desc 'check', 'Review the container platform configuration to verify audit records
                    are generated on successful/unsuccessful attempts to modify security levels. If
                    audit records are not generated, this is a finding.'
  desc 'fix', 'Configure the container platform to generate audit
                records when successful/unsuccessful attempts to modify security levels.'
  impact 0.5
  tag check_id: 'C-36193r601258_chk'
  tag severity: 'medium'
  tag gid: 'V-233257'
  tag rid: 'SV-233257r961806_rule'
