control 'SRG-APP-000151-CTR-000365' do
  ...
  desc 'To ensure accountability and prevent unauthenticated
                ...
                potential misuse and compromise of the system. Multifactor authentication is defined
                ...
                biometric). A privileged account is defined as an information system account with
                authorizations of a privileged user. Local access is defined as access to an
                organizational information system by a user (or process acting on behalf of a user)
                communicating through a direct connection without the use of a
                network.'
  desc 'check', 'Review the container platform configuration to determine if
                    multifactor authentication is used for local access to privileged accounts. If
                    multifactor authentication for local access to privileged accounts is not being
