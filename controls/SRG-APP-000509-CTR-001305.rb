control 'SRG-APP-000509-CTR-001305' do
  title 'The container platform must generate audit records for all account creations,
  ...
  desc 'check', 'Review the container platform configuration to determine if the
                    container platform is configured to generate audit records for all account
                    creations, modifications, disabling, and termination events. If the container
                    platform is not configured to generate the audit records, this is a finding.'
  desc 'fix', 'Configure the container platform to generate audit
                records for all account creations, modifications, disabling, and termination events.'
  impact 0.5
  tag check_id: 'C-36205r601885_chk'
  tag severity: 'medium'
  tag gid: 'V-233269'
  tag rid: 'SV-233269r961842_rule'
