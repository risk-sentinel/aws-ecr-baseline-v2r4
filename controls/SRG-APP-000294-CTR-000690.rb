control 'SRG-APP-000294-CTR-000690' do
  ...
  desc 'When application accounts are removed, user
                ...
                removal events to the system administrator and ISSO is one method for mitigating
  ...
  desc 'check', 'Review the container platform configuration to determine if system
                    administrators and ISSO are notified when accounts are removed. If system
                    administrators and ISSO are not notified, this is a finding.'
  desc 'fix', 'Configure the container platform to notify system
                administrators and ISSO when accounts are removed.'
  impact 0.5
