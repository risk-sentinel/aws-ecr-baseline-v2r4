control 'SRG-APP-000830-CTR-000190' do
  title 'The container platform must for password-based authentication, maintain a list of
                commonly used, expected, or compromised passwords on an organization-defined
                frequency.'
  desc 'Password-based authentication applies to passwords
                ...
                derivatives
                thereof.'
  desc 'check', 'Verify the container platform is configured to maintain a list of
                    commonly used, expected, or compromised passwords on an organization-defined
                    frequency. If the container platform is not configured to maintain a list of
                    commonly used, expected, or compromised passwords on an organization-defined
                    frequency, this is a finding.'
  desc 'fix', 'Configure the container platform to maintain a list
                of commonly used, expected, or compromised passwords on an organization-defined
                frequency.'
  impact 0.5
  tag check_id: 'C-67491r981911_chk'
  tag severity: 'medium'
  tag gid: 'V-263591'
  tag rid: 'SV-263591r981913_rule'
  tag stig_id: 'SRG-APP-000830-CTR-000190'
  tag gtitle: 'SRG-APP-000830'
  tag fix_id: 'F-67399r981912_fix'
  tag 'documentable'
  tag cci: ['CCI-004058']
  tag nist: ['IA-5 (1) (a)']
end
