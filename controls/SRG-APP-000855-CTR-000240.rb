control 'SRG-APP-000855-CTR-000240' do
  title 'The container platform must for password-based authentication, require immediate
  ...
  desc 'Password-based authentication applies to passwords
                ...
                derivatives
                thereof.'
  desc 'check', 'Verify the container platform is configured to require immediate
                    selection of a new password upon account recovery. If the container platform is
                    not configured to require immediate selection of a new password upon account
                    recovery, this is a finding.'
  desc 'fix', 'Configure the container platform to require
                immediate selection of a new password upon account recovery.'
  impact 0.5
  tag check_id: 'C-67495r982464_chk'
  tag severity: 'medium'
  tag gid: 'V-263595'
  tag rid: 'SV-263595r982465_rule'
  tag stig_id: 'SRG-APP-000855-CTR-000240'
  tag gtitle: 'SRG-APP-000855'
  tag fix_id: 'F-67403r981924_fix'
  tag 'documentable'
  tag cci: ['CCI-004063']
  tag nist: ['IA-5 (1) (e)']
end
