control 'SRG-APP-000402-CTR-000970' do
  title 'The container platform must accept Personal Identity Verification (PIV)
  ...
  desc 'Controlling access to the container platform and its
                ...
                accept PIV credentials from other federal agencies and eliminate the possibility of
                access being denied to authorized users. PIV credentials are those credentials
  ...
  desc 'check', 'Review the documentation and configuration to determine if the
                    container platform accepts PIV credentials from other federal agencies. If the
                    container platform does not accept other federal agency PIV credentials, this is
                    a finding.'
  desc 'fix', 'Configure the container platform to accept PIV
                credentials from other federal agencies.'
  impact 0.5
