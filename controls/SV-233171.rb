control 'SV-233171' do
  title 'The container platform must provide an immediate real-time alert to the SA and
                security officer, at a minimum, of all audit failure events requiring real-time alerts.'
  ...
  desc 'check', 'Review the container platform configuration to determine if it is
                    configured to provide an immediate real-time alert to the SA and security officer of all
  ...
  desc 'fix', 'Configure the container platform to provide an
                immediate real-time alert to the SA and security officer of all audit failure events requiring
                real-time alerts.'
  impact 0.5
