control 'SRG-APP-000494-CTR-001230' do
  ...
  desc 'check', 'Review the container platform configuration to verify audit records
                    are generated on successful/unsuccessful attempts to access categories of
                    information. If audit records are not generated, this is a finding.'
  desc 'fix', 'Configure the container platform to generate audit
                records on successful/unsuccessful attempts to access categories of information.'
  impact 0.5
  tag check_id: 'C-36190r601249_chk'
  tag severity: 'medium'
  tag gid: 'V-233254'
  tag rid: 'SV-233254r961797_rule'
