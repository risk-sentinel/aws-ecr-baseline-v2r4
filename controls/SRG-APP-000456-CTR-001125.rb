control 'SRG-APP-000456-CTR-001125' do
  ...
  # Registry-layer ECR assertion (scan-on-push surfaces CVEs so images stay current); account-wide, scoped via assessed_repositories.
