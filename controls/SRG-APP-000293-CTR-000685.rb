control 'SRG-APP-000293-CTR-000685' do
  title 'The container platform must notify system administrators and ISSO for account
                disabling actions.'
  desc 'When application accounts are disabled, user
                ...
                account disabling events to the system administrator and ISSO is one method for
  ...
  desc 'check', 'Review the container platform configuration to determine if system
                    administrators and ISSO are notified when accounts are disabled. If system
                    administrators and ISSO are not notified, this is a finding.'
  desc 'fix', 'Configure the container platform to notify system
                administrators and ISSO when accounts are disabled.'
  impact 0.5
