control 'SV-233033' do
 title 'The container platform must retain the organization-defined login banner on the screen until users acknowledge the usage and conditions and take
 ...
 impact 0.0
 describe 'the organization-defined login banner retention: no platform-provided interactive session/console UI (N/A)' do
 subject { true }
