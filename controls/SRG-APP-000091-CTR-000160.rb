control 'SRG-APP-000091-CTR-000160' do
  ...
  desc 'check', 'Review the container platform configuration to determine if it is
                    configured to generate audit records when successful/unsuccessful attempts are
                    made to access privileges. If the container platform is not configured to
                    generate audit records on successful/unsuccessful access to privileges, this is
                    a finding.'
  desc 'fix', 'Configure the container platform to generate audit
                records when successful/unsuccessful attempts are made to access privileges occur.'
  impact 0.5
  tag check_id: 'C-35976r601616_chk'
  tag severity: 'medium'
  tag gid: 'V-233040'
  tag rid: 'SV-233040r960885_rule'
